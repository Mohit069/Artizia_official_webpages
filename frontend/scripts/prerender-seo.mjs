...
const ROUTES = [
  ...
  },
  {
    ...
    og: [['og:title', 'About Artizia — Quartz Slab Manufacturer, Exporter & Supplier'], ['og:description', '35 years of engineered-stone heritage. A quartz slab supplier to North America, the UK and Australia — now crafting luxury quartz surfaces and super jumbo quartz slabs for India.'], ['og:type', 'website']],
  },
  ...
  { file: 'warranty.html', title: 'Warranty — Artizia Quartz', description: 'Every Artizia engineered quartz surface is backed by a Lifetime Warranty against manufacturing defects — scratches, stains, heat, chemicals, mould and mildew.', canonical: 'https://artizia.co.in/warranty.html' },
