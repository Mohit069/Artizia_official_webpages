...
const ROUTES = [
  ...
  },
  {
    ...
    og: [['og:title', 'About Artizia — Quartz Slab Manufacturer, Exporter & Supplier'], ['og:description', '40 years of engineered-stone heritage. A quartz slab supplier to North America, the UK and Australia — now crafting luxury quartz surfaces and jumbo quartz slabs for India.'], ['og:type', 'website']],
  },
  ...
  { file: 'certifications.html', title: 'Certifications — Artizia Quartz', description: 'Artizia quartz is GreenGuard and NSF certified — proof of low emissions, food-safe surfaces and independent quality assurance.', canonical: 'https://artizia.co.in/certifications.html' },
  ...
  { file: 'catalogue.html', title: 'Artizia Catalogue — Premium Engineered Quartz Surfaces', description: 'Browse the full Artizia catalogue — 53 engineered quartz designs across five collections, jumbo 3300 × 1650 mm slabs, pressed on Breton Stone technology in Jaipur, India.', canonical: 'https://artizia.co.in/catalogue',
    og: [['og:type', 'website'], ['og:site_name', 'Artizia'], ['og:url', 'https://artizia.co.in/catalogue'], ['og:title', 'Artizia Catalogue — Premium Engineered Quartz Surfaces'], ['og:description', '53 engineered quartz designs across five collections. Jumbo 3300 × 1650 mm slabs, pressed on Breton Stone technology in Jaipur.'], ['og:image', 'https://artizia.co.in/uploads/catalogue-cover.jpg']] },
