...
const P: any = {
  ...
  why: {
    ...
    cards: [
      { icon: 'breton', title: 'Breton Stone Technology', text: "Every slab is vibro-compressed on Breton machinery — the benchmark the world's leading luxury quartz surfaces are made on." },
  ...
  making: {
    ...
    lead: [
      'At Artizia, manufacturing excellence is driven by innovation, precision, and uncompromising quality. Our state-of-the-art facility utilizes Breton Stone technology and advanced automation to produce premium Engineered Quartz Slabs with outstanding consistency and performance.',
    ...
    tiles: [
      { size: 'lg', n: '03', title: 'Breton Stone Technology', image: 'assets/img/process/03-breton-technology.jpg', alt: 'Breton vibro-compression press forming engineered quartz slabs' },
  ...
  values: {
    ...
    list: [
      ...
      { title: 'Innovation', text: 'Breton Stone technology, delivering consistent, durable, design-forward slabs.' },
