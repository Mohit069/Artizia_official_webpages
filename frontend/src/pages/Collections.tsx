...
const PAGE = {
  banner: {
    ...
    lead: 'From marble-veined luxury to quiet everyday essentials — every Artizia surface is engineered on Breton Stone technology and backed for 15 years.',
  },
  cta: {
...
/* "Visualize" — the same TilesView link as the product page's "View in my
   Home" button. Rendered on every card; without a link it is inert rather
   than missing. */
