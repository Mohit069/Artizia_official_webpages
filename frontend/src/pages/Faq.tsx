...
const PAGE = {
  ...
  faqs: [
    ...
    { q: 'What is engineered quartz?', a: 'Engineered quartz combines roughly 90–93% natural quartz aggregate with resins and pigments, compacted under vacuum and vibration on Breton Stone technology. The result is a non-porous surface that is harder, more consistent and more durable than natural stone.' },
